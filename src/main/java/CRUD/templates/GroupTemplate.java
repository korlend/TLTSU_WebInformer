...
import CRUD.mappers.GroupMapper;
 ...
 */
public class GroupTemplate extends JdbcTemplate {
    ...
    public GroupTemplate(JdbcTemplate jdbcTemplateMySQL, JdbcTemplate jdbcTemplateOracle) {
    ...
    public void setDataSourceMySQL(JdbcTemplate jdbcTemplate) {
        ...
        this.jdbcInsertMySQL = new SimpleJdbcInsert(jdbcTemplate).withTableName("Group").withSchemaName("tltsudb");
    }
