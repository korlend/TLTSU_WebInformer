...
import CRUD.mappers.StreamMapper;
import CRUD.tables.Stream;
 ...
 */
public class StreamTemplate extends JdbcTemplate {
    ...
    public StreamTemplate(JdbcTemplate jdbcTemplateMySQL, JdbcTemplate jdbcTemplateOracle) {
    ...
    public void setDataSourceMySQL(JdbcTemplate jdbcTemplate) {
        ...
        this.jdbcInsertMySQL = new SimpleJdbcInsert(jdbcTemplate).withTableName("Stream").withSchemaName("tltsudb");
    }
